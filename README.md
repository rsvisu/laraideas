...
Al crear una cuenta o iniciar sesion se da la posibilidad de crear una idea poniendo su titulo y descripcion. 

También permite visualizar las ideas creadas junto a botones para modificarlas o borrarlas.
